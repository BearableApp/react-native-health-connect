import type { InstantaneousRecord, IntervalRecord, Pressure, Temperature, TimeRangeFilter, Mass, HeartRateSample, SleepStage } from './base.types';
...
export type HealthConnectRecord = BloodPressureRecord | BodyTemperatureRecord | HeartRateRecord | RestingHeartRateRecord | StepsRecord | HeartRateVariabilityRmssdRecord | WeightRecord | SleepSessionRecord;
